<div class="view-title-menu set-font f-17" align="center">مدریت بنر های وسط</div>
<div class="view-item-table">
    ...
    <table>
        ...
        @foreach($banner_centers as $item)
            <tr class="f-13 tr-view-item-table-admin">
                ...
                <td><a href="{{route('admin.delete.deleteBannerCenter' ,$item->id )}}" class="btn-delete">حذف</a></td>
            </tr>
        @endforeach
    </table>
</div>
...
<div class="group-form-new-comment group-input-for-login-register page-create-admin">
    ...
    <div class="line"></div>
    <form action="{{route('admin.createAdmin.createBannerCenter')}}" method="post" enctype="multipart/form-data">
        @csrf
